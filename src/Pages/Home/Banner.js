...
import portfolioImage from "../../assets/images/img.jpg";
    ...
    <section className="grid lg:grid-cols-2 items-center">
      <div className="order-2 lg:order-1">
        <h1 className="text-xl lg:text-2xl font-serif">
          Hello, My name is
          <br />
          <span className="font-bold text-4xl lg:text-5xl text-sky-700">
            Zannatul Binta Bahar
          </span>
        </h1>
        <p className="text-3xl font-semibold font-serif opacity-50">
        ...
        <div className="my-5 text-lg">
          <p className="flex items-center">
            ...
            <a
              href="mailto:zannatulbintabahar@yahoo.com"
              aria-label="My email"
              title="My email"
      ...
      {/* image  */}
      <div className="p-5 lg:p-16 order-1 lg:order-2 lg:ml-32">
